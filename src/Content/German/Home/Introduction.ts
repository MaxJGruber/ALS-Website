export const introduction = {
  ...
  part2: {
    title: "Expert advice for the best of services",
    description1: `Our team of experts can provide you with all the services you need under one roof to help open the door to your new lifestyle, including:`,
    list: [
      "Finding your property and the buying process",
      "Everything you need to do when you relocate",
