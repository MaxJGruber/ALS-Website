export const financialAdvice = {
  ...
  adviceTitle: `We can help and advise you on:`,
  adviceList: [
    `Retirement Planning`,
    `Pension transfers`,
    `Estate Planning`,
  ...
  text2: `Being Independent Financial Advisors and Insurance brokers means we are not linked to one company or product and will look for the best possible tailor-made solutions for your individual needs.`,
};
