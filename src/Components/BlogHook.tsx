      ...
      <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-evenly">
          <a
            ...
            rel="noreferrer"
            title="Google"
            className="mt-8 w-full inline-flex items-center justify-center px-3 py-3 border border-transparent text-4xl font-medium rounded-xl text-indigo-600 bg-white hover:bg-tertiary-pink hover:text-yellow-200 sm:w-auto"
          >
