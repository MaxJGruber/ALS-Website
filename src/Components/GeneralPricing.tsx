    ...
    <div className="bg-pastel-yellow">
      <div className="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-4xl mx-auto text-xl text-gray-300 sm:mt-5 sm:text-2xl">
            ...
            <br /> <br /> As each case is different a detailed quote will be
            given once we have had the opportunity to understand how we can help
            you, however please find below an example of some of our packages.
            <br /> <br />
      ...
      <div className="mt-16 bg-white pb-12 lg:mt-20 lg:pb-20">
        <div className="relative z-0">
          <div className="absolute inset-0 h-5/6 bg-pastel-yellow lg:h-2/3" />
                      ...
                      <div>
                        ...
                        <div className="mt-4 flex items-center justify-center">
                          <span className="px-3 flex items-start text-6xl tracking-tight text-gray-900">
                            <span className="font-extrabold">1195</span>{" "}
                    ...
                    <div>
                      ...
                      <div className="mt-4 flex items-center justify-center">
                        <span className="px-3 flex items-start text-6xl tracking-tight text-gray-900 sm:text-6xl">
                          <span className="font-extrabold">1695</span>{" "}
                          <span className="mt-2 mr-2 text-4xl font-medium">
                            €
                          </span>
                        </span>
                  ...
                  <div className="flex-1 flex flex-col">
                    <div className="bg-white px-6 py-10">
                      <div>
                        ...
                        <div className="mt-4 flex items-center justify-center">
                          <span className="px-3 flex items-start text-6xl tracking-tight text-gray-900">
                            <span className="font-extrabold">2495</span>{" "}
                            <span className="mt-2 mr-2 text-4xl font-medium">
                              €
                            </span>
                          </span>
